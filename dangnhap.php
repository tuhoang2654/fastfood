    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div style="background-color:#d74b33;float: left;color: white;">
                <h1
                    style="font-size: 24px; font-weight: normal; padding: 0 12px; text-align: left; margin: 0!important;line-height: 31px">
                    ĐĂNG NHẬP
                </h1>
            </div>
            ...
            <div id="form" class="col-md-8 col-md-offset-2 col-xs-12 col-sm-12 col-xs-offset-0 col-sm-offset-0">
                <form method="POST" name="login">
                    <div class="form-group">
                        <label for="taikhoan" class="col-sm-4 control-label" style="text-align:right;">Tài khoản
                        </label>
                        <div class="col-sm-8">
