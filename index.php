...
<div id="slide">
    <div id="container">
        <div id="slideshow" class="cycle-slideshow" data-cycle-fx="fade" data-cycle-manual-fx="scrollHorz"
            data-cycle-pager-fx="fade" data-cycle-manual-speed="860" data-cycle-prev="#prev" data-cycle-next="#next"
            data-cycle-speed="800" data-cycle-timeout="3000" data-cycle-pager="#pager"
            data-cycle-pager-template="<a href='#'><img src='{{src}}' width=150 height=100></a>" <img
            src="IMAGES/lm5.jpg" id="intro_img" />
    ...
    <div class="prt_title" style="padding: 10px 0 5px 0px;">
        <div style="background-color:#d74b33;float: left;color: white;">
            <h1
                ...
                <?php echo _text('featured products') ?>
            </h1>
        </div>
        ...
        <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="product-item">
                ...
                <?php
									...
									?>
                <div class="prt_item_buy" onclick="addCart(<?php echo $masp;?>);"
                    style="cursor: pointer;display:flex;flex-direction:row;justify-content:center;margin-right:10px;">
